export default function DemoPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-display-lg text-brand-500 mb-8">Typography Demo</h1>

      {/* Display */}
      <section className="mb-12">
        <h2 className="text-heading-lg text-brand-900 mb-4">Display</h2>
      ...
      {/* Heading */}
      <section className="mb-12">
        <h2 className="text-heading-lg text-brand-900 mb-4">Heading</h2>
      ...
      {/* Label */}
      <section className="mb-12">
        <h2 className="text-heading-lg text-brand-900 mb-4">Label</h2>
        <div className="space-y-4">
      ...
      {/* Caption */}
      <section className="mb-12">
        <h2 className="text-heading-lg text-brand-900 mb-4">Caption</h2>
        <div className="space-y-4">
          <div className="flex flex-col gap-1">
            <input type="text" className="border rounded px-2 py-1" placeholder="Input field" />
            <span className="text-caption-xl text-brand-600">Caption XL - Additional information text</span>
          </div>
          <div className="flex flex-col gap-1">
            <input type="text" className="border rounded px-2 py-1" placeholder="Input field" />
            <span className="text-caption-lg text-brand-600">Caption LG - Helper text for form fields</span>
          </div>
          <div className="flex flex-col gap-1">
            <input type="text" className="border rounded px-2 py-1" placeholder="Input field" />
            <span className="text-caption-md text-brand-600">Caption MD - Supplementary information</span>
          </div>
          <div className="flex flex-col gap-1">
            <input type="text" className="border rounded px-2 py-1" placeholder="Input field" />
            <span className="text-caption-sm text-brand-600">Caption SM - Small helper text</span>
          </div>
          <div className="flex flex-col gap-1">
            <input type="text" className="border rounded px-2 py-1" placeholder="Input field" />
            <span className="text-caption-xs text-brand-600">Caption XS - Minimal supporting text</span>
          </div>
        </div>
      </section>
      ...
      {/* Real-world Example */}
      <section className="mb-12">
        <h2 className="text-heading-lg text-brand-900 mb-4">Real-world Example</h2>
